...
list_capacitors = filter_components_by_category(cell_values, CAT_SMD_CAPACITOR)

list_idx, list_name, list_comp_type, list_footprint, list_pad, list_manu, list_lib_type = zip(*list_capacitors)
# print(set(list_footprint))
# sys.exit(1)

# list_capacitors = list_capacitors[1:10]
