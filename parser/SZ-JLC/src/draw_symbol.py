...
SMD_AVALANCHE_DIODE_SYMBOL=SMD_DEFAULT_SYMBOL
...
SMD_CAPACITOR_SYMBOL=SMD_DEFAULT_SYMBOL
...
SMD_DIODE_SYMBOL=SMD_DEFAULT_SYMBOL
...
SMD_INDUCTOR_SYMBOL=SMD_DEFAULT_SYMBOL
...
SMD_LED_DRIVE_SYMBOL=SMD_DEFAULT_SYMBOL
SMD_LED_RESISTOR_SYMBOL=SMD_DEFAULT_SYMBOL
SMD_LED_SYMBOL=SMD_DEFAULT_SYMBOL
...
SMD_MCU_MONITORING_CHIP_SYMBOL=SMD_DEFAULT_SYMBOL
...
SMD_RESISTOR_SYMBOL=SMD_DEFAULT_SYMBOL
...
SMD_SECOND_CLASSIFICATION_OF_ENGINEERING_DEPARTMENT_DATA_SYMBOL=SMD_DEFAULT_SYMBOL
...
SMD_MICROCONTROLLER_MCU_SYMBOL=SMD_DEFAULT_SYMBOL
