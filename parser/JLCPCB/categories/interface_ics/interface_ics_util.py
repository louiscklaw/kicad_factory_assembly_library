...
def handle_jlc_interface_ics(cell_values_array, m_r):
  ...
  try:
    ...
    # translate
    temp_lib = gen_interface_ics.getLibText(*[
          component_name,
    ...
    temp_dcm = gen_interface_ics.getDcmText(*[
          component_name,
          cell_values_array[COL_NUM_PACKAGE],
          r_accuracy,
          lcsc_part,
...
def general_handler(cell_values):
  # print('interface_ics general handler')
  ...
  if m_with_package_size:
    return handle_jlc_interface_ics(cell_values, m_with_package_size)
  ...
  # bottom rule
    ...
    print('missing_implementation in interface_ics_util.py.general_handler')
    print('SOLVE: missing_implementation in interface_ics_util.py.general_handler')
