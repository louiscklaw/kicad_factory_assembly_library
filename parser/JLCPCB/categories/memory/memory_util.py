...
def handle_jlc_memory(cell_values_array, m_r):
  ...
  try:
    ...
    # translate
    temp_lib = gen_memory.getLibText(*[
          component_name,
    ...
    temp_dcm = gen_memory.getDcmText(*[
          component_name,
          cell_values_array[COL_NUM_PACKAGE],
          r_accuracy,
          lcsc_part,
...
def general_handler(cell_values):
  ...
  if m_with_package_size:
    return handle_jlc_memory(cell_values, m_with_package_size)
  ...
  # bottom rule
    ...
    print('missing_implementation in memory_util.py.general_handler')
    print('SOLVE: missing_implementation in memory_util.py.general_handler')
