...
def handle_jlc_amplifiers(cell_values_array, m_r):
  ...
  try:
    ...
    r_accuracy = None
    # translate
    temp_lib = gen_amplifiers.getLibText(*[
          text_value,
    ...
    temp_dcm = gen_amplifiers.getDcmText(
...
def general_handler(cell_values):
  # print('amplifiers general handler')
  ...
  if m_with_package_size:
    return handle_jlc_amplifiers(cell_values, m_with_package_size)
