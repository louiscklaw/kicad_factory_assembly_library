...
def handle_jlc_filters(cell_values_array, m_r):
  ...
  try:
    ...
    r_accuracy = None
    # translate
    temp_lib = gen_filters.getLibText(*[
          text_value,
    ...
    temp_dcm = gen_filters.getDcmText(
...
def general_handler(cell_values):
  ...
  if m_with_package_size:
    return handle_jlc_filters(cell_values, m_with_package_size)
    ...
    print('missing_implementation in filters_util.py.general_handler')
    print('SOLVE: missing_implementation in filters_util.py.general_handler')
