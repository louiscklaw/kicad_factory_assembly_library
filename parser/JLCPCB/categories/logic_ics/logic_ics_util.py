...
def handle_jlc_logic_ics(cell_values_array, m_r):
  ...
  try:
    ...
    temp_lib = gen_logic_ics.getLibText(*[
          component_name,
    ...
    temp_dcm = gen_logic_ics.getDcmText(*[
          component_name,
          cell_values_array[COL_NUM_PACKAGE],
          r_accuracy,
          cell_values_array[COL_NUM_LCSC_PART],
...
def general_handler(cell_values):
  # print('logic_ics general handler')
  ...
  if m_with_package_size:
    return handle_jlc_logic_ics(cell_values, m_with_package_size)
  ...
  # bottom rule
    ...
    print('missing_implementation in logic_ics_util.py.general_handler')
    print('SOLVE: missing_implementation in logic_ics_util.py.general_handler')
