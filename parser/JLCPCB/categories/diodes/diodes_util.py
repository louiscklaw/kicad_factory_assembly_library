...
def handle_jlc_diodes(cell_values_array, m_r):
  ...
  try:
    ...
    # translate
    temp_lib = gen_diodes.getLibText(*[
          component_name,
    ...
    temp_dcm = gen_diodes.getDcmText(*[
          component_name,
          cell_values_array[COL_NUM_PACKAGE],
          r_accuracy,
          lcsc_part,
...
def general_handler(cell_values):
  ...
  if m_with_package_size:
    return handle_jlc_diodes(cell_values, m_with_package_size)
  ...
  # bottom rule
    ...
    print('missing_implementation in diodes_util.py.general_handler')
    print('SOLVE: missing_implementation in diodes_util.py.general_handler')
