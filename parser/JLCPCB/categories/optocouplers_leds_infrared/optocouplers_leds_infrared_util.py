...
import gen_optocouplers_leds_infrared
...
def handle_jlc_optocouplers_leds_infrared(cell_values_array, m_r):
  ...
  try:
    ...
    temp_lib = gen_optocouplers_leds_infrared.getLibText(*[
          component_name,
    ...
    temp_dcm = gen_optocouplers_leds_infrared.getDcmText(*[
          component_name,
          cell_values_array[COL_NUM_PACKAGE],
          r_accuracy,
          cell_values_array[COL_NUM_LCSC_PART],
...
def general_handler(cell_values):
  # print('optocouplers_leds_infrared general handler')
  ...
  if m_with_package_size:
    return handle_jlc_optocouplers_leds_infrared(cell_values, m_with_package_size)
  ...
  # bottom rule
    ...
    print('missing_implementation in optocouplers_leds_infrared_util.py.general_handler')
    print('SOLVE: missing_implementation in optocouplers_leds_infrared_util.py.general_handler')
