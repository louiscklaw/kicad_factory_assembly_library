...
import gen_embedded_peripheral_ics
...
def handle_jlc_embedded_peripheral_ics(cell_values_array, m_r):
  ...
  try:
    ...
    # translate
    temp_lib = gen_embedded_peripheral_ics.getLibText(*[
          component_name,
    ...
    temp_dcm = gen_embedded_peripheral_ics.getDcmText(*[
          component_name,
          cell_values_array[COL_NUM_PACKAGE],
          r_accuracy,
          lcsc_part,
...
def general_handler(cell_values):
  # print('embedded_peripheral_ics general handler')
  ...
  if m_with_package_size:
    return handle_jlc_embedded_peripheral_ics(cell_values, m_with_package_size)
  ...
  # bottom rule
    ...
    print('missing_implementation in embedded_peripheral_ics_util.py.general_handler')
    print('SOLVE: missing_implementation in embedded_peripheral_ics_util.py.general_handler')
