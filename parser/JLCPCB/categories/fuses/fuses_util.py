...
def general_handler(cell_values):
  ...
  if m_with_package_size:
    return handle_jlc_fuses(cell_values, m_r)
    ...
    print('missing_implementation in fuses_util.py.general_handler')
    print('SOLVE: missing_implementation in fuses_util.py.general_handler')
