...
import gen_embedded_processors_controllers
...
def handle_jlc_embedded_processors_controllers(cell_values_array, m_r):
  ...
  try:
    ...
    temp_lib = gen_embedded_processors_controllers.getLibText(*[
          component_name,
    ...
    temp_dcm = gen_embedded_processors_controllers.getDcmText(*[
          component_name,
          cell_values_array[COL_NUM_PACKAGE],
          r_accuracy,
          cell_values_array[COL_NUM_LCSC_PART],
...
def general_handler(cell_values):
  # print('embedded_processors_controllers general handler')
  ...
  if m_with_package_size:
    return handle_jlc_embedded_processors_controllers(cell_values, m_with_package_size)
  ...
  # bottom rule
    ...
    print('missing_implementation in embedded_processors_controllers_util.py.general_handler')
    print('SOLVE: missing_implementation in embedded_processors_controllers_util.py.general_handler')
