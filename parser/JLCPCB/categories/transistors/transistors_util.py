...
def handle_jlc_transistors(cell_values_array, m_r):
  ...
  try:
    ...
    # translate
    temp_lib = gen_transistors.getLibText(*[
          component_name,
    ...
    temp_dcm = gen_transistors.getDcmText(*[
          component_name,
          cell_values_array[COL_NUM_PACKAGE],
          r_accuracy,
          lcsc_part,
...
def general_handler(cell_values):
  # print('transistors general handler')
  ...
  if m_with_package_size:
    return handle_jlc_transistors(cell_values, m_with_package_size)
  ...
  # bottom rule
    ...
    print('missing_implementation in transistors_util.py.general_handler')
    print('SOLVE: missing_implementation in transistors_util.py.general_handler')
