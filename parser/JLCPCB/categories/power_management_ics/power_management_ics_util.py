...
import gen_power_management_ics
...
def handle_jlc_power_management_ics(cell_values_array, m_r):
  ...
  try:
    ...
    r_accuracy = None
    # translate
    temp_lib = gen_power_management_ics.getLibText(*[
          text_value,
    ...
    temp_dcm = gen_power_management_ics.getDcmText(
...
def general_handler(cell_values):
  ...
  if m_with_package_size:
    return handle_jlc_power_management_ics(cell_values, m_with_package_size)
