...
import gen_inductors_chokes_transformers
...
def handle_jlc_inductors_chokes_transformers(cell_values_array, m_r):
  ...
  try:
    ...
    temp_lib = gen_inductors_chokes_transformers.getLibText(*[
          component_name,
...
def general_handler(cell_values):
  # print('inductors_chokes_transformers general handler')
  ...
  if m_with_package_size:
    return handle_jlc_inductors_chokes_transformers(cell_values, m_with_package_size)
  ...
  # bottom rule
    ...
    print('missing_implementation in inductors_chokes_transformers_util.py.general_handler')
    print('SOLVE: missing_implementation in inductors_chokes_transformers_util.py.general_handler')
